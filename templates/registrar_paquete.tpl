        ...
        <div class="row">
            <div class="input-field col s12">
                ...
                <select name="arquitectura" id = "arquitectura" class="browser-default" required>
                        <option value="{$arquitectura}" disabled selected>selecione una arquitectura por favor</option>
        ...
        <div class="row">
            <div class="input-field col s12">
                ...
                <select name="repositorio" id = "repositorio" class="browser-default" required>
                    <option value="{$repositorio}" disabled selected>selecione un repositorio</option>

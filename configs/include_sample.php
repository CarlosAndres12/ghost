...
define('C_FULL_PATH', '/opt/lampp/htdocs/ghost/'); //full path

define('C_L_GLOBAL', 'http://localhost/ghost/'); //application global link
define('C_N_GLOBAL', 'Ghost'); //application global title
